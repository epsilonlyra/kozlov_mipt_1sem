...
OBJECTS = []  # list of ingame objects(missiles, player, enemyguns, targets)
...
class GameEnd(Sign):
    ...
    def show(self):
        global finished
        if self.timer2.ready(self.maxtime):
            finished = True
        super().show()
